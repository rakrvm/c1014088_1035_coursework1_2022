public class Testing {
    ...
    public static void main(String[] args) {
        ...
        testingReport.branchList.get(0).addSale(new Sale(14, "NE147AQ", 500.00, "April", 2003));
        testingReport.branchList.get(1).addSale(new Sale(15, "NE157AQ", 6000, "May", 2007));
        testingReport.branchList.get(2).addSale(new Sale(16, "NE167AQ", 700.100, "June", 2008));
